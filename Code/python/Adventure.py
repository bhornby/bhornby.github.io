...
fryingpan = Item(desc = "greasy pan", actions = ["clean"])
...
kitchen = Room(desc="the palace of the enlightened eclaire", contents={"eclaire":eclaire, "fryingpan":fryingpan})
...
while True:
    ...
    if cmd == "help":
        ...
        if len(rooms[y][x].contents.items()) == 0:
        ...
        elif itemname in rooms[y][x].contents:
            item = rooms[y][x].contents[itemname]
            print(item.desc)
